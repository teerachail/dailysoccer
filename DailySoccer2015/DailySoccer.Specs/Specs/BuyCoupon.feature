...
Background: Initialize background
	...
	| u04-unverify-phone    | 400    | 0             | +66812345678 | v04          |                   | true               |                 |
	| u05-invalid-phone     | 400    | 0             |              |              | 1/1/2016          | true               |                 |
...
@mock
Scenario: ผู้ใช้ซื้อคูปอง ในขณะที่ระบบยังไม่เปิดให้ซื้อ ระบบไม่ทำการซื้อคูปอง
...
@mock
Scenario: ผู้ใช้ที่มีข้อมูลการยืนยันเบอร์โทรศัพท์ไม่ถูกต้องซื้อคูปอง ระบบไม่ทำการซื้อคูปอง
	When Call POST api/Coupons UserId: 'u05-invalid-phone', BuyAmount: '1'
	Then ระบบไม่ทำการซื้อคูปอง
